...
public class Supers {
    ...
    public Supers(String name, List<String> list, boolean isHeroes) {
        this(ID.getAndIncrement(), name, list, isHeroes);
    }

    public Supers(int id, String name, List<String> list, boolean isHeroes) {
        this.id = id;
        this.name = name;
    ...
    public JsonObject toJson() {
        return new JsonObject()
                .put("id", id)
                .put("name", name)
                .put("superpowers", superpowers.stream().collect(
                        (Supplier<JsonArray>) JsonArray::new, JsonArray::add, JsonArray::addAll))
                .put("villain", villain);
    }
}
